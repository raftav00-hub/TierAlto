...
- **Tagline below wordmark:** "Where Expertise Meets Accountability." teal italic, smaller
- **No image logo file exists yet** — build as styled HTML/CSS text
...
| Asset | Status |
|-------|--------|
| TIERALTO wordmark | CSS/HTML text only — no image file |
| Logo image | Not yet available — add when created |
...
1. No image assets exist at launch. All image slots render as styled placeholder
   divs — colored bg + centered italic label text. Never leave broken img tags.

2. Wordmark is CSS/HTML text only. TIERALTO styled as Inter 800 uppercase.
